...
class WAIRDDatamodule(WAIRDBaseDatamodule):
    ...
    def prepare_data(self) -> None:
        self._train_set = WAIRDDataset(data_path=self.__data_path, scenario=self.__scenario, split="train")
        self._val_set = WAIRDDataset(data_path=self.__data_path, scenario=self.__scenario, split="val")
